...
BEGIN
  ...
  SET is_admin = true
  WHERE id = '0f4f967b-34dc-44d5-bdbb-572ce867caf2'::uuid
    AND family_id = 'b12e8cea-0a2b-42a3-8f24-d01b5ba6f364'::uuid
    AND display_name = 'Rakib';
  IF NOT FOUND THEN
    RAISE EXCEPTION 'The verified Rakib membership no longer matches';
  END IF;
END;
$$;
